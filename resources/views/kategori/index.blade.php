        ...
        <div class="relative p-4 w-full max-w-2xl max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-4 md:p-5 space-y-4">
                    <form action="{{ route('kategori.store') }}" method="POST" class="max-w-sm mx-auto">
                        @csrf
                        ...
                        <div class="mb-5">
                            <label for="judul"
                                ...
                                Kategori</label>
                            <input type="namakategori" id="kategori" name="namakategori" value=""
        ...
        <div class="relative overflow-x-auto">
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                        <th scope="col" class="px-6 py-3">Kategori ID</th>
                ...
                <tbody>
                    @foreach ($kategori as $kategori)
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td class="px-6 py-4">
                                <!-- Modal Edit-->
                                <button data-modal-target="edit-modal{{ $kategori->namakategori }}"
                                    data-modal-toggle="edit-modal{{ $kategori->namakategori }}"
                                    type="button"
                                ...
                                <!-- Main modal -->
                                <div id="edit-modal{{ $kategori->namakategori }}" tabindex="-1" aria-hidden="true"
                                    class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                    <div class="relative p-4 w-full max-w-2xl max-h-full">
                                        <!-- Modal content -->
                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                            ...
                                            <div class="p-4 md:p-5 space-y-4">
                                                @isset($kategori)
                                                    <form action="{{ route('kategori.update', $kategori->kategoriID) }}"
                                                        ...
                                                        <div class="mb-5">
                                                            <label for="namakategori"
                                                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-black">Nama
                                                                Kategori</label>
                                                            <input type="namakategori" id="namakategori"
                                                                name="namakategori"
                                    ...
                                    <div class="relative p-4 w-full max-w-md max-h-full">
                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                            ...
                                            <div class="p-4 md:p-5 text-center">
                                                ...
                                                <form
                                                    action="{{ route('kategori.destroy', $kategori->kategoriID) }}"
